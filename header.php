...
<?='
	<header class="header">
		<div class="container">
			<h1 class="logo">
				<a href="'; echo $aik['pcdomain'];?>" title="<?php echo $aik['keywords'];?>">
					<?php echo $aik['logo_dh'];?>
					<span><?php echo $aik['title'];?><?='</span>
				</a>
			</h1>
			<div class="sitenav">
				<ul>
					<li id="menu-item-18" class="menu-item">
						<a href="'; echo $aik['pcdomain']?>">首页</a>
					</li>
				<ul>
				<ul>
					<!-- <li id="menu-item-18" class="menu-item"><a href="/yuanxian.php">院线大片</a>
					</li> -->
			...
			<span class="sitenav-on">
				<i class="icon-list"></i>
			</span>
			<span class="sitenav-mask"></span>
			<div class="accounts">
				<a class="account-weixin" href="javascript:;">
					<i class="fa"></i>
					<div class="account-popover">
						<div class="account-popover-content">'; echo $aik['weixin_ad'];?><?='</div>
					</div>
				</a>
			</div>
			...
			<form method="post" class="searchform" action="./seacher.php" >
				...
				<i class="fa"></i>
				</button><input tabindex="2" class="sinput" name="wd" type="text" placeholder="输入关键字" value="">
			</form>			
		</div>
